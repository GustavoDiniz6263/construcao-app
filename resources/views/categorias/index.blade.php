                    ...
                    <table class="min-w-full border-collapse border border-gray-300">
                        <thead>
                            <tr class="bg-gray-100">
                                <th class="border border-gray-300 px-6 py-3 text-left font-semibold">Tipo</th>
                                <th class="border border-gray-300 px-6 py-3 text-left font-semibold">Aplicacao</th>
                        ...
                        <tbody>
                            @foreach($categorias as $categoria)
                                <tr class="hover:bg-gray-50">
                                    <td class="border border-gray-300 px-6 py-3">{{ $categoria->tipo }}</td>
